...
public class homework {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Arrays are equal: " + Arrays.equals(data1, data1));
    ...
    private static void sequentialMethod(float[] data, int offset) {
        for (int index = 0; index < data.length; index++) {
            ...
            data[index] = computateValeue(index + offset, currentValue);
        }
    }
    ...
    private static float computateValeue(int index, float currentValue) {
